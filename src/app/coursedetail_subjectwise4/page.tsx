...
import inner from "../images/subject_wise_course_module/course4.jpg";
        ...
        <div className="row mb-4">
              ...
              <div className="col-lg-8">
                <div className="price_Details">
                  ...
                  <a href="https://mgxpi.courses.store/173774?utm_source%3Dother%26utm_medium%3Dtutor-course-referral%26utm_campaign%3Dcourse-overview-webapp" target="_blank">
          ...
          <br></br>
            <h4> About the Programme</h4><br></br>
              <p>	Learn environment & ecology in Organized & Simplified manner.</p>
