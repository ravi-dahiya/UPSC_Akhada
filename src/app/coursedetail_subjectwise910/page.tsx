...
import inner from "../images/subject_wise_course_module/course910.jpg";
        ...
        <div className="row mb-4">
              ...
              <div className="col-lg-8">
                <div className="price_Details">
                  ...
                  <a href="https://mgxpi.courses.store/293100?utm_source%3Dother%26utm_medium%3Dtutor-course-referral%26utm_campaign%3Dcourse-overview-webapp" target="_blank">
          ...
          <br></br>
            ...
            <p>	COMPLETE COURSE WITH ANSWER WRITING	</p>
            <p>	PDF NOTES	</p>
